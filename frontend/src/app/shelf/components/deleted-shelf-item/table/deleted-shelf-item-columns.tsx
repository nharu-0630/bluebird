...
import { DeletedShelfItemRowActions } from "./deleted-shelf-item-row-actions";

export const DeletedShelfItemColumns: ColumnDef<ShelfItem>[] = [
  {
    id: "select",
    header: ({ table }) => (
  ...
  {
    id: "actions",
    cell: ({ row }) => <DeletedShelfItemRowActions row={row} />,
    enableHiding: false,
  },
];
