...
export type GetTwitterUserQuery = { __typename?: 'Query', twitterUser?: { __typename?: 'TwitterUser', id?: string | null, name?: string | null, screenName?: string | null, verified?: boolean | null, blueVerified?: boolean | null, description?: string | null, location?: string | null, birthday?: any | null, createdAt?: any | null, friendsCount?: number | null, following?: boolean | null, fastFollowersCount?: number | null, followersCount?: number | null, normalFollowersCount?: number | null, followedBy?: boolean | null, mediaCount?: number | null, favouritesCount?: number | null, listedCount?: number | null, pinnedTweetIDs?: Array<string | null> | null, profileBannerURL?: string | null, profileImageURL?: string | null, statusesCount?: number | null } | null };
...
export const RemoveShelfItemImageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RemoveShelfItemImage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"ulid"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"fileKey"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"removeShelfItemImage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"ulid"},"value":{"kind":"Variable","name":{"kind":"Name","value":"ulid"}}},{"kind":"Argument","name":{"kind":"Name","value":"fileKey"},"value":{"kind":"Variable","name":{"kind":"Name","value":"fileKey"}}}]}]}}]} as unknown as DocumentNode<RemoveShelfItemImageMutation, RemoveShelfItemImageMutationVariables>;
