...
func (c *TwitterClient) Likes(userID string, cursor ...string) ([]model.Tweet, model.Cursor, error) {
	...
	return ParseTimelineAddEntries(instruction)
}

func (c *TwitterClient) Bookmarks(cursor ...string) ([]model.Tweet, model.Cursor, error) {
	if c.config.IsGuestTokenEnabled {
	...
	for _, instruction := range instructions {
		...
		if instructionType == "TimelineAddEntries" {
			return ParseTimelineAddEntries(instruction.(map[string]interface{}))
		}
	}
	return nil, model.Cursor{}, err
}

func (c *TwitterClient) UserTweets(userID string, cursor ...string) ([]model.Tweet, model.Cursor, error) {
